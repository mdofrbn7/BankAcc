 ...
 */
         ...
         f.setBackground(new java.awt.Color(41, 180, 255));
         JLabel l =new JLabel("WELCOME TO BANK RECORD MANAGER");
         l.setHorizontalAlignment((int) CENTER_ALIGNMENT);
         l.setHorizontalTextPosition((int) CENTER_ALIGNMENT);
        l.setBounds(10,10,800,50);
        l.setFont(new Font("Serif", Font.BOLD, 25));
        JButton b1 = new JButton("Create Account");
        b1.setBounds(40, 170,150, 50);
        b1.setBackground(new java.awt.Color(150, 168, 183));
